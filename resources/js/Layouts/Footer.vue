        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 px-4 py-11 sm:px-6 md:grid-cols-6 lg:px-8">
            <div class="m-2 flex justify-center space-x-6 xl:col-span-6">
                ...
                <a
                    ...
                    target="_blank"
                    class="text-slate-950 hover:text-pink-700 dark:text-white dark:hover:text-pink-700"
                >
                ...
                <a
                    ...
                    target="_blank"
                    class="text-slate-950 hover:text-sky-700 dark:text-white dark:hover:text-sky-700"
                >
                ...
                <a
                    ...
                    target="_blank"
                    class="text-slate-950 hover:text-green-700 dark:text-white dark:hover:text-green-700"
                >
