<script setup>
import { ref } from 'vue';
import { Bars3Icon, XMarkIcon, ChevronDownIcon } from '@heroicons/vue/20/solid';
    ...
    <header class="bg-white dark:bg-slate-800 fixed top-0 z-50 w-full shadow-sm">
        <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
            ...
            <el-popover-group class="hidden lg:flex lg:gap-x-12">
                <div class="relative">
                    ...
                    <el-popover id="desktop-menu-product" anchor="bottom" popover class="w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg outline-1 outline-slate-900/5 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
                        <div class="p-4">
                            ...
                            <!-- <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-slate-50 dark:hover:bg-white/5">
                                <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-slate-50 group-hover:bg-white dark:bg-slate-700/50 dark:group-hover:bg-slate-700">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 text-slate-600 group-hover:text-indigo-600 dark:text-slate-400 dark:group-hover:text-white">
                                ...
                                <div class="flex-auto">
                                    <a href="#" class="block font-semibold text-slate-900 dark:text-white">
                                        Analytics
                                        <span class="absolute inset-0"></span>
                                    </a>
                                    <p class="mt-1 text-slate-600 dark:text-slate-400">Get a better understanding of your traffic</p>
                                </div>
                            </div> -->
                            <!-- <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-slate-50 dark:hover:bg-white/5">
                                <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-slate-50 group-hover:bg-white dark:bg-slate-700/50 dark:group-hover:bg-slate-700">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <p class="mt-1 text-slate-600 dark:text-slate-400">Speak directly to your customers</p>
                                </div>
                            </div>
                            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-slate-50 dark:hover:bg-white/5">
                                <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-slate-50 group-hover:bg-white dark:bg-slate-700/50 dark:group-hover:bg-slate-700">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <p class="mt-1 text-slate-600 dark:text-slate-400">Your customers’ data will be safe and secure</p>
                                </div>
                            </div>
                            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-slate-50 dark:hover:bg-white/5">
                                <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-slate-50 group-hover:bg-white dark:bg-slate-700/50 dark:group-hover:bg-slate-700">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <p class="mt-1 text-slate-600 dark:text-slate-400">Connect with third-party tools</p>
                                </div>
                            </div>
                            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-slate-50 dark:hover:bg-white/5">
                                <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-slate-50 group-hover:bg-white dark:bg-slate-700/50 dark:group-hover:bg-slate-700">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <p class="mt-1 text-slate-600 dark:text-slate-400">Build strategic funnels that will convert</p>
                                </div>
                            </div> -->
                        </div>
                        <!-- <div class="grid grid-cols-2 divide-x divide-slate-900/5 bg-slate-50 dark:divide-white/10 dark:bg-slate-700/50">
                            <a href="#" class="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700/50">
                                <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="size-5 flex-none text-slate-400 dark:text-slate-500">
                ...
                <!-- <a href="#" class="text-sm/6 font-semibold text-slate-900 dark:text-white">Features</a>
                <a href="#" class="text-sm/6 font-semibold text-slate-900 dark:text-white">Marketplace</a>
                <a href="#" class="text-sm/6 font-semibold text-slate-900 dark:text-white">Company</a> -->
            </el-popover-group>
