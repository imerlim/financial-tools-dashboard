...
const products = [
    ...
    { name: 'Calculadora de investimentos', description: 'Calcula juros compostos', href: '/calculadora-juros-compostos', icon: CursorArrowRaysIcon },
...
<template>
    <header class="bg-white dark:bg-slate-800 fixed top-0 z-50 w-full p-2">
