    ...
    <div class="sm:col-span-2">
        ...
        <div class="flex items-center w-full" :class="{ 'gap-2': showTrash || showClear || showSearch || showAdd }">
            ...
            <div class="flex-grow min-w-0">
                <div class="flex items-center w-full overflow-hidden rounded-lg px-2 bg-slate-50 dark:bg-slate-700" :class="[error ? 'border border-red-500 focus-within:ring-red-500' : 'border border-slate-300 dark:border-slate-600 focus-within:ring-blue-500 focus-within:border-blue-500', 'focus-within:ring-1']">
                    <!-- Prepend -->
