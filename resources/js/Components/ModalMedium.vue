                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    @click="emitClose"
                                    class="p-1 rounded-full text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-sky-500"
                                >
                            ...
                            <!-- Rodapé -->
                            <div
                                v-if="actionTitle || $slots.footer"
                                class="flex justify-end items-center gap-x-4 p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700"
                            >
                                <slot name="footer">
                                    <button
                                        type="button"
                                        class="px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-700 rounded-md border dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-600"
                                        @click="emitClose"
                                    >
                                        Cancelar
                                    </button>
                                    <button
                                        v-if="actionHandler"
                                        type="button"
                                        class="px-4 py-2 text-sm font-semibold text-white bg-sky-600 rounded-md shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                                        @click="actionHandler"
                                    >
                                        {{ actionTitle }}
                                    </button>
